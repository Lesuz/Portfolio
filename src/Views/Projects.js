    ...
    return (
        <div  id="projects-header" className="app-projects">
            ...
            <div class="app-project-information">
                    ...
                    />
                    <div>
                    <p className="usedSkills">React</p>
                ...
                <div class="app-project-information">
                    ...
                    />
                    <div>
                    <p className="usedSkills">JavaScript, HTML, CSS, Covid19 API</p>
                ...
                <div class="app-project-information">
                    ...
                    />
                    <div>
                    <p className="usedSkills">React Native</p>
                ...
                <div class="app-project-information">
                    ...
                    />
                    <div>
                    <p className="usedSkills">JavaScript, HTML, CSS</p>
