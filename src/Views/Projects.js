        ...
        <div  id="projects-header" className="app-projects">
            ...
            <div class="app-project-information">
                    ...
                    <p>This portfolio is a project in which I practiced and learned some basics of React. It was my 
                        ...
                        projects I have done. My CV can also be downloaded by manually saving it. <a href="https://coronaintheworld.netlify.app/" target="_blank">here</a>.</p>
                    </div>
                </div>
                <div class="app-project-information">
                    <img 
                    ...
                    until the end of the year 2020. The app can be found <a href="https://coronaintheworld.netlify.app/" target="_blank">here</a>.</p>
                    </div>
                </div>
                <div class="app-project-information">
                    <img 
                    ...
                    The app was made in the fall of 2020 and it was a part of course where I got introduced to React Native. The code can be found <a href="https://github.com/Lesuz/TaskListApp" target="_blank">here</a>.
                    </p>
                    </div>
                </div>
                <div class="app-project-information">
                    ...
                    <p>Simple To Do List web app where the user can input the task, when it has to be done and color code it according to how important the task is. The app only has some 
                        ...
                        tested out <a href="https://susannastodolist.netlify.app/" target="_blank">here</a> </p>
                    </div>
                </div>
            </div>
        </div>
